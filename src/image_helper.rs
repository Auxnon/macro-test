...
pub fn flip(img: &Image,index: usize) -> Image {
    ...
    for i in 0..w {
        for j in 0..32 {
           ...
           /* im.get_image_data_mut()[(i * 32 as u32 + j) as usize][0]=0.into();
            im.get_image_data_m
            ut()[(i * 32 as u32 + j) as usize][1]=0.into();
            ...
            let c=im.get_image_data()[(i * 32 + j) as usize][index];
            im.get_image_data_mut()[(i * 32 + j) as usize][index]=255-c;//v.into();
